...
export class QuoteComponent implements OnInit {
  quotes: Quote[] = [
    ...
    new Quote(1, 'Be more concerned with your character than your reputation, because your character is what you really are, while your reputation is merely what others think you are', 'John Wooden','Mary Waithera', new Date(2019,0,18)),
