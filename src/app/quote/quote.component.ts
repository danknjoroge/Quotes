...
export class QuoteComponent implements OnInit {
  quotes: Quote[] = [
    ...
    new Quote(1, 'Believe in yourself and all that you are. Know that there is something inside you that is greater than any obstacle', 'Christian Larson','Jane Njoki', new Date(2021,4,11, 13,34)),
